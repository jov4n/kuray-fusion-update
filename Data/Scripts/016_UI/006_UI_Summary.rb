...
class PokemonSummary_Scene
  ...
  def drawPageOne
    ...
    if @pokemon.isFusion?
      head_species = @pokemon.species_data ? @pokemon.species_data.get_head_species : nil
      body_species = @pokemon.species_data ? @pokemon.species_data.get_body_species : nil
      head_obj = getPokemon(head_species)
      body_obj = getPokemon(body_species)
      headName = head_obj ? head_obj.name : "???"
      bodyName = body_obj ? body_obj.name : "???"
      ...
      dex_obj = GameData::Species.try_get(@pokemon.species)
