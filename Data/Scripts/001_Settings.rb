...
module Settings
  ...
  # Enable extra logging for fusion sprite resolution.
  ...
  CUSTOM_DEX_ENTRIES_PATH = "Data/pokedex/dex_migrated.json"
  AI_DEX_ENTRIES_PATH = "Data/pokedex/generated_entries.json"
  POKEDEX_ENTRIES_PATH = "Data/pokedex/all_entries_migrated.json"
  ...
  ROAMING_SPECIES = [
    ...
    [:"F__243_OFFICIAL.245_OFFICIAL", 50, 341, 1, "Legendary Birds",ROAMING_AREAS,:Storm],
    [:"F__378_OFFICIAL.379_OFFICIAL", 50, 602, 0, "Legendary Birds",SEVII_ROAMING,:StrongWinds],
    [:"F__379_OFFICIAL.378_OFFICIAL", 50, 602, 0, "Legendary Birds",SEVII_ROAMING,:StrongWinds],
