...
def changeMeloettaForm(pokemon)
  ...
  if is_meloetta_A && is_meloetta_P
    if pokemon.species_data.get_body_species() == :MELOETTA_A
      changeSpeciesSpecific(pokemon, GameData::SpeciesId.official_fusion_id(467, 466))
    else
      changeSpeciesSpecific(pokemon, GameData::SpeciesId.official_fusion_id(466, 467))
    end
