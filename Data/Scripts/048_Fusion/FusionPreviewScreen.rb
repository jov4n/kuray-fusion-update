class FusionPreviewScreen < DoublePreviewScreen
  ...
  def initialize(poke1,poke2, usingSuperSplicers=false)
    ...
    # KIF MIGRATION: Use helper to support Symbols/Fakemon
    fusion_left = getSpeciesIdForFusion(poke2.species, poke1.species)
    fusion_right = getSpeciesIdForFusion(poke1.species, poke2.species)
