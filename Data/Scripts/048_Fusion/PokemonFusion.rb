...
class PokemonFusionScene
  ...
  def pbStartScreen(pokemon1, pokemon2, newspecies,splicerItem)
    ...
    poke1_id = @pokemon1.species
    poke2_id = @pokemon2.species
    ...
    @sprites["rsprite1"].setPokemonBitmapFromId(poke1_id, false, pokemon1.shiny?, false, false, pokemon1.shinyValue?, pokemon1.shinyR?, pokemon1.shinyG?, pokemon1.shinyB?, pokemon1.shinyKRS?)
    @sprites["rsprite3"].setPokemonBitmapFromId(poke2_id, false, pokemon2.shiny?, false, false, pokemon2.shinyValue?, pokemon2.shinyR?, pokemon2.shinyG?, pokemon2.shinyB?, pokemon2.shinyKRS?)
  ...
  def pbFusionScreen(cancancel = false, superSplicer = false, firstOptionSelected = false)
    ...
    if canceled
      ...
      newSpecies = GameData::Species.try_get(@newspecies)
      newspeciesname = newSpecies ? newSpecies.real_name : "???"
      oldSpecies = GameData::Species.try_get(@pokemon1.species)
      oldspeciesname = oldSpecies ? oldSpecies.real_name : "???"
...
def setFusionMoves(fusedPoke, poke2, selected2ndOption = false)
  ...
  body_obj = GameData::Species.try_get(bodySpecies)
  head_obj = GameData::Species.try_get(headSpecies)
  bodySpeciesName = body_obj ? body_obj.real_name : "Body Species"
  headSpeciesName = head_obj ? head_obj.real_name : "Head Species"
