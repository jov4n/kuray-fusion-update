class PokemonPokedexInfo_Scene
  ...
  def pbGetAvailableForms(species=nil)
    ...
    species_data = GameData::Species.try_get(chosen_species)
    if species_data && !GameData::SpeciesId.official_namespace?(species_data.namespace)
      # Custom/fakemon: rely on direct file lookup
    else
  ...
  def list_pokemon_forms
    ...
    return [] if species_data && !GameData::SpeciesId.official_namespace?(species_data.namespace)
