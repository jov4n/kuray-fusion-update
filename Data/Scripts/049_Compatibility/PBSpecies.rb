...
#In some places, pokemon are instanciated as PBSpecies::NAME in wild battles, trades, etc. which doesn't work anymore.
  ...
  VOLTORB = :VOLTORB
  ELECTRODE = :ELECTRODE
  B101H135 = GameData::SpeciesId.official_fusion_id(101, 135)
  B100H101 = GameData::SpeciesId.official_fusion_id(100, 101)
  B101H26 = GameData::SpeciesId.official_fusion_id(101, 26)
  ENTEI = :ENTEI
  PIDGEOTTO = :PIDGEOTTO
  FEAROW =:FEAROW
  SPEAROW =:SPEAROW
  B18H18 = GameData::SpeciesId.official_fusion_id(18, 18)
  B245H243 = GameData::SpeciesId.official_fusion_id(245, 243)
