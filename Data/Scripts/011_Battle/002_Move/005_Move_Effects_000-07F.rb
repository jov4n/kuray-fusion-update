  ...
  def pbEndOfMoveUsageEffect(user, targets, numHits, switchedBattlers)
    ...
    if is_meloetta_A && is_meloetta_P
      if user.pokemon.species_data.get_body_species() == :MELOETTA_A
        changeSpeciesSpecific(user.pokemon, GameData::SpeciesId.official_fusion_id(467, 466))
      else
        changeSpeciesSpecific(user.pokemon, GameData::SpeciesId.official_fusion_id(466, 467))
      end
